...
export const METRICS: Array<{
  ...
  { key: 'fiber_g', name: 'Ballaststoffe', group: 'nutrition', unit: 'g', type: 'number', decimals: 1, agg: 'sum', dir: 'higher_better', target: { value: 30, minus: 10, plus: 20, hardMin: 10 }, color: 'var(--series-6)', sort: 24 },
